...
keydir="$(mktemp -d)"
kubeconfig="/home/licheng/work/k8sconf/ywzt/config"
...
#kubectl --kubeconfig ${kubeconfig} create namespace linkedcare-system

# Create the TLS secret for the generated keys.
kubectl --kubeconfig "${kubeconfig}" -n linkedcare-system create secret tls skyworking-inject-webhook-server-tls \
